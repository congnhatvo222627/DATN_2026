...
FIELD_SPECS = [
    {
        ...
        "type": "bool",
        "group": "Preprocess",
        "group_note": "Buoc 1: tang tuong phan va lam muot ROI truoc khi tach nguong.",
    },
    ...
    {"path": "preprocess.gaussian_sigma", "label": "Gaussian sigma", "type": "float", "group": "Preprocess", "min": 0.0, "max": 5.0},
    {
    ...
    {"path": "radius_filter.inner_margin_px", "label": "Inner margin px", "type": "float", "group": "Radius", "min": -50.0, "max": 50.0},
    {"path": "radius_filter.outer_margin_px", "label": "Outer margin px", "type": "float", "group": "Radius", "min": -50.0, "max": 80.0},
    {

...
FIELD_SPECS = [
    {
        "path": "fit_preprocess.use_clahe",
        "label": "Use CLAHE",
        "type": "bool",
        "group": "Fit Preprocess",
        "group_note": "Buoc 1A: tien xu ly nhe tren toan ROI de fit ellipse mep trong cua than stator.",
    },
    {"path": "fit_preprocess.clahe_clip_limit", "label": "CLAHE clip", "type": "float", "group": "Fit Preprocess", "min": 0.1, "max": 10.0},
    {"path": "fit_preprocess.clahe_tile_grid_size", "label": "CLAHE tile", "type": "int", "group": "Fit Preprocess", "min": 1, "max": 32},
    {"path": "fit_preprocess.use_gaussian", "label": "Use Gaussian", "type": "bool", "group": "Fit Preprocess"},
    {"path": "fit_preprocess.gaussian_kernel", "label": "Gaussian kernel", "type": "int", "group": "Fit Preprocess", "min": 1, "max": 31},
    {"path": "fit_preprocess.gaussian_sigma", "label": "Gaussian sigma", "type": "float", "group": "Fit Preprocess", "min": 0.0, "max": 5.0},
    {
        "path": "preprocess.use_clahe",
        "label": "Use CLAHE",
        "type": "bool",
        "group": "Tab Preprocess",
        "group_note": "Buoc 1B: tien xu ly rieng cho viec tach tab sau khi da co annulus mask.",
    },
    {"path": "preprocess.clahe_clip_limit", "label": "CLAHE clip", "type": "float", "group": "Tab Preprocess", "min": 0.1, "max": 10.0},
    {"path": "preprocess.clahe_tile_grid_size", "label": "CLAHE tile", "type": "int", "group": "Tab Preprocess", "min": 1, "max": 32},
    {"path": "preprocess.use_gaussian", "label": "Use Gaussian", "type": "bool", "group": "Tab Preprocess"},
    {"path": "preprocess.gaussian_kernel", "label": "Gaussian kernel", "type": "int", "group": "Tab Preprocess", "min": 1, "max": 31},
    {"path": "preprocess.gaussian_sigma", "label": "Gaussian sigma", "type": "float", "group": "Tab Preprocess", "min": 0.0, "max": 5.0},
    {
        "path": "threshold.use_otsu",
        "label": "Use Otsu",
        "type": "bool",
        "group": "Threshold",
        "group_note": "Buoc 2: tach ROI thanh anh nhi phan trang den de tim cac vung can loc.",
    },
    {"path": "threshold.compute_on_full_roi", "label": "Compute threshold on full ROI", "type": "bool", "group": "Threshold"},
    {"path": "threshold.invert", "label": "Invert binary", "type": "bool", "group": "Threshold"},
    {"path": "threshold.manual_value", "label": "Manual value", "type": "int", "group": "Threshold", "min": 0, "max": 255},
    {
        "path": "radius_filter.enabled",
        "label": "Use radius band",
        "type": "bool",
        "group": "Radius",
        "group_note": "Buoc 3: chi giu mot vanh quanh than stator de tranh lay nham vung trong/ngoai.",
    },
    {"path": "radius_filter.r_min_factor", "label": "r_min_factor (mep trong)", "type": "float", "group": "Radius", "min": 0.7, "max": 1.2},
    {"path": "radius_filter.r_max_factor", "label": "r_max_factor (mep ngoai)", "type": "float", "group": "Radius", "min": 1.0, "max": 1.6},
    {"path": "radius_filter.ellipse_cut_offset_px", "label": "Ellipse cut offset px", "type": "float", "group": "Radius", "min": -20.0, "max": 80.0},
    {"path": "radius_filter.fallback_to_circle_on_fit_error", "label": "Fallback to circle on fit error", "type": "bool", "group": "Radius"},
    {
        "path": "binary_cleanup.enabled",
        "label": "Enable cleanup",
        "type": "bool",
        "group": "Binary Cleanup",
        "group_note": "Buoc 3B: khu nhieu tren binary chi trong annulus truoc khi tach component.",
    },
    {"path": "binary_cleanup.use_median", "label": "Use median", "type": "bool", "group": "Binary Cleanup"},
    {"path": "binary_cleanup.median_kernel", "label": "Median kernel", "type": "int", "group": "Binary Cleanup", "min": 1, "max": 15},
    {"path": "binary_cleanup.use_morph_open", "label": "Use morph open", "type": "bool", "group": "Binary Cleanup"},
    {"path": "binary_cleanup.open_kernel", "label": "Open kernel", "type": "int", "group": "Binary Cleanup", "min": 1, "max": 15},
    {"path": "binary_cleanup.open_iterations", "label": "Open iterations", "type": "int", "group": "Binary Cleanup", "min": 1, "max": 10},
    {
        "path": "component_filter.min_area",
        "label": "Min area",
        "type": "int",
        "group": "Component",
        "min": 0,
        "max": 50000,
        "group_note": "Buoc 4: tach cac component lien thong tren binary_ring va loc theo dien tich. Min area la nguong chinh; Max area chi dung khi > 0.",
    },
    {"path": "component_filter.max_area", "label": "Max area", "type": "int", "group": "Component", "min": 0, "max": 120000},
    {
        "path": "canny.threshold1",
        "label": "Canny threshold1",
        "type": "int",
        "group": "Canny",
        "min": 0,
        "max": 500,
        "group_note": "Buoc 5: tao edge cuoi cung tu mask da chon de dua sang phan radial signature.",
    },
    {"path": "canny.threshold2", "label": "Canny threshold2", "type": "int", "group": "Canny", "min": 0, "max": 500},
]

...
FIELD_SPECS = [
    ...
    {"path": "preprocess.gaussian_sigma", "label": "gaussian_sigma", "type": "float", "group": "Preprocess", "min": 0.0, "max": 5.0},
    {"path": "threshold.use_otsu", "label": "use_otsu", "type": "bool", "group": "Threshold"},
    {"path": "threshold.invert", "label": "invert_binary", "type": "bool", "group": "Threshold"},
    {"path": "threshold.manual_value", "label": "manual_value", "type": "int", "group": "Threshold", "min": 0, "max": 255},
    ...
    {"path": "radius_filter.inner_margin_px", "label": "inner_margin_px", "type": "float", "group": "Radius", "min": -50.0, "max": 50.0},
    {"path": "radius_filter.outer_margin_px", "label": "outer_margin_px", "type": "float", "group": "Radius", "min": -50.0, "max": 80.0},
    {"path": "component_filter.min_area", "label": "min_area", "type": "int", "group": "Component", "min": 0, "max": 50000},
    {"path": "component_filter.max_area", "label": "max_area", "type": "int", "group": "Component", "min": 0, "max": 120000},
    {"path": "component_filter.max_angle_span_deg", "label": "max_span_deg", "type": "float", "group": "Component", "min": 0.0, "max": 360.0},
]
